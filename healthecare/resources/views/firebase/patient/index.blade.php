...
<html lang="en" dir="ltr">
  ...
  <link href="https://fonts.googleapis.com/css2?family=Anton&family=Josefin+Sans&family=Mali:wght@600&family=Passion+One&family=Paytone+One&family=Righteous&display=swap" rel="stylesheet">
    ...
    <div class="wrapper">
        ...
        <aside class="left-sidebar sidebar-light" id="left-sidebar">
          <div id="sidebar" class="sidebar sidebar-with-footer">
            ...
            <div class="app-brand">
              <a href="/index.html">
                <img src="images/logo.png" alt="Mono" style="width: 30%" >
                <span class="brand-name">HEALTH-E CARE</span>
              </a>
            </div>
              ...
              <ul class="nav sidebar-inner" id="sidebar-menu">
                  ...
                  <li
                   >
                    <a class="sidenav-item-link" href="team.html">
                      ...
                      <span class="nav-text">Individual Treatment
                        <br> Record</span>
                    </a>
                  </li>
                  ...
                  <li
                   >
                    <a class="sidenav-item-link" href="calendar.html">
                      ...
                      <span class="nav-text">Patient Enrollment
                        <br> Record</span>
                    </a>
                  </li>
                  ...
                  <li  class="has-sub" >
                    <a class="sidenav-item-link" href="javascript:void(0)" data-toggle="collapse" data-target="#email"
                      ...
                      <span class="nav-text">Resident Record</span> <b class="caret"></b>
                    </a>
                      ...
                      <div class="sub-menu">
                            ...
                            <li >
                              <a class="sidenav-item-link" href="email-inbox.html">
                                <span class="nav-text">Barangay</span>
